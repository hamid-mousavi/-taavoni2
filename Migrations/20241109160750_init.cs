        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProofSupply = table.Column<decimal>(type: "TEXT", nullable: false),
                    Taxes = table.Column<decimal>(type: "TEXT", nullable: false),
                    Assessment = table.Column<decimal>(type: "TEXT", nullable: false),
                    ThreePersonAssessment = table.Column<decimal>(type: "TEXT", nullable: false),
                    WaterCompanyAssessment = table.Column<decimal>(type: "TEXT", nullable: false),
                    TotalDebt = table.Column<decimal>(type: "TEXT", nullable: false),
                    IsPaid = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FixedDebts", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PenaltyRate = table.Column<decimal>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
